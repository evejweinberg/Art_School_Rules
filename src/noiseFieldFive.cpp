...
void noiseFieldFive::setup(){
	scaleOfField = 0.001f;
}


ofVec2f noiseFieldFive::getNoiseForPosition(float x, float y, float scale){
...
void	noiseFieldFive::setTime(float t){
	noiseTime = t;
}